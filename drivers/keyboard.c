...
char shift_scan_code_table[NUM_OF_KEYCODES] = {
  0,    // 0x00
  0,    // 0x01
  '!',  // 0x02
  '@',  // 0x03
...
int key_pressed[NUM_OF_KEYCODES];
...
void keyboard_interrupt_handler()
{
  ...
  if (scan_code < NUM_OF_KEYCODES) {
    key_pressed[scan_code] = 1;
  } else {
  ...
  char c = 0;
  if (key_pressed[LSHIFT] + key_pressed[RSHIFT] > 0) {
